![image](https://github.com/NorthPole0499/Cloud_Technologies/assets/46933758/0677c27d-499b-41ac-96c5-77738725db68)
...
|Azure Cosmos DB| Облачная глобально распределённая база данных NoSQL, предлагающая масштабируемость и гибкость для работы с различными видами данных.|
|Azure Blob Storage|Надежное, доступное и масштабируемое облачное хранилище для больших объёмов неструктурированных данных.|
...
|Azure Site Recovery| Облачная служба восстановления, предназначенная для обеспечения защиты критически важных приложений и данных в случае аварий или сбоев.|
|Azure Backup| Экономичное и безопасное решение, обеспечивающее резервное копирование облачных и локальных данных, которое масштабируется в зависимости от потребностей пользователя в хранилище резервных копий.|
